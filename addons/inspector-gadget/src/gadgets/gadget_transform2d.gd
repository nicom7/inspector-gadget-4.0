...
func populate_controls() -> void:
	...
	var x_axis_gadget = GadgetVector2.new(NodePath("../../" + str(node_path)), subnames + ":x")
	...
	var y_axis_gadget = GadgetVector2.new(NodePath("../../" + str(node_path)), subnames + ":y")
	...
	var origin_gadget = GadgetVector2.new(NodePath("../../" + str(node_path)), subnames + ":origin")
